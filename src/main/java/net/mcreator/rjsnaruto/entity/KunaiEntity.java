...
public class KunaiEntity extends AbstractArrow implements ItemSupplier {
	public KunaiEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(RjsNarutoModEntities.KUNAI.get(), world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(RjsNarutoModItems.KUNAI.get());
	}
	...
	public static KunaiEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		KunaiEntity entityarrow = new KunaiEntity(RjsNarutoModEntities.KUNAI.get(), entity, world);
	...
	public static KunaiEntity shoot(LivingEntity entity, LivingEntity target) {
		KunaiEntity entityarrow = new KunaiEntity(RjsNarutoModEntities.KUNAI.get(), entity, entity.level);
