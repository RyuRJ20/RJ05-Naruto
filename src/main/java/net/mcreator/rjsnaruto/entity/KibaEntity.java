...
public class KibaEntity extends AbstractArrow implements ItemSupplier {
	public KibaEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(RjsNarutoModEntities.KIBA.get(), world);
	}

	public KibaEntity(EntityType<? extends KibaEntity> type, Level world) {
		super(type, world);
	}

	public KibaEntity(EntityType<? extends KibaEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public KibaEntity(EntityType<? extends KibaEntity> type, LivingEntity entity, Level world) {
	...
	public static KibaEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		KibaEntity entityarrow = new KibaEntity(RjsNarutoModEntities.KIBA.get(), entity, world);
	...
	public static KibaEntity shoot(LivingEntity entity, LivingEntity target) {
		KibaEntity entityarrow = new KibaEntity(RjsNarutoModEntities.KIBA.get(), entity, entity.level);
