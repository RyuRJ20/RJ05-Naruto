...
public class KibaRenderer extends EntityRenderer<KibaEntity> {
	...
	@Override
	public void render(KibaEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
